...
rm -f "${LOG_ROOT}/covtype/s2/test_acc_dim54_int1_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/covtype/s2/test_acc_dim54_int1_gen1_pseudo_prototypes_bic_curves.jsonl" "${LOG_ROOT}/covtype/s2/test_acc_dim2048_int1_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/covtype/s2/test_acc_dim2048_int1_gen1_pseudo_prototypes_bic_curves.jsonl"
...
rm -f "${LOG_ROOT}/color_mnist/s0/test_acc_dim54_int1_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/color_mnist/s0/test_acc_dim54_int1_gen1_pseudo_prototypes_bic_curves.jsonl" "${LOG_ROOT}/color_mnist/s0/test_acc_dim2048_int1_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/color_mnist/s0/test_acc_dim2048_int1_gen1_pseudo_prototypes_bic_curves.jsonl"
...
rm -f "${LOG_ROOT}/portraits/s0/test_acc_dim54_int0_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/portraits/s0/test_acc_dim54_int0_gen1_pseudo_prototypes_bic_curves.jsonl" "${LOG_ROOT}/portraits/s0/test_acc_dim2048_int0_gen1_pseudo_prototypes_bic.txt" "${LOG_ROOT}/portraits/s0/test_acc_dim2048_int0_gen1_pseudo_prototypes_bic_curves.jsonl"
